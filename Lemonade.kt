            ...
            when(current) {
                1 -> {
                    LemonTextAndImage(
                        ...
                        description = R.string.selectlemon,
                        textlabel = R.string.lemon_tree,
                        onImageclick = {
                            current = 2
                            numberofclicks = (2..4).random()
                        }
                    )
                }
                2 -> {
                    LemonTextAndImage(
                        ...
                        description = R.string.squeezelemon,
                ...
                3 -> {
                    LemonTextAndImage(
                        ...
                        description = R.string.drink,
                        textlabel = R.string.full_glass,
                        onImageclick = {
                            current = 4
                        }
                    )
                    ...
                    LemonTextAndImage(
                        ...
                        description = R.string.startagain,
